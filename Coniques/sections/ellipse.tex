...
\marginpar{\raisebox{-.2ex}{\includegraphics[height=4ex]{./images/icon/roue.PNG}}\footnotemark[15]}
\footnotetext[15]{Jacques Marot, \url{https://www.geogebra.org/m/yvmuuvx9#material/fsaph7pe}}
...
\marginpar{\raisebox{-.2ex}{\includegraphics[height=4ex]{./images/icon/roue.PNG}}\footnotemark[16]}
\footnotetext[16]{Jacques Marot, \url{https://www.geogebra.org/m/yvmuuvx9#material/jkubyjmd}}
...
\includegraphics[scale = 0.7]{sections/tikz_standalone/ell_3.pdf}
\end{minipage}
\hfill
\begin{minipage}{0.5\textwidth}
\includegraphics[scale = 0.7]{sections/tikz_standalone/ell_4.pdf}
\end{minipage}

\vspace{1pt}
\hspace{0.3\textwidth}
\begin{minipage}{0.5\textwidth}
\includegraphics[scale = 0.7]{sections/tikz_standalone/ell_5.pdf}
...
\begin{minipage}{0.5\textwidth}
   \begin{eleve}
    Comme cet exemple d'ellipse est rapportée à ses axes:\\
    Le centre est $(0,0)$\\
...
\newpage
\subsection{Définition monofocale}\label{section:ellmonofo}
Jusqu’à présent, nous avons étudié les définitions bifocales des coniques. 
Nous allons maintenant nous intéresser à leurs définitions monofocales.
...
Un développement similaire peut être fait pour l'hyperbole et sera présenté dans la section \ref{section:hypmonofo}.

Il est également possible de montrer que la parabole admet une définition monofocale. Cela nous conduit ainsi à la définition monofocale des coniques.
...
Lorsque $0<\varepsilon<1$, la conique est une \textbf{ellipse}.\\
Lorsque $\varepsilon=1$, la conique est une \textbf{parabole}.\\
Lorsque $\varepsilon>1$, la conique est une \textbf{hyperbole}.\\
\end{tcolorbox}

Dans le cas de l'ellipse, $\varepsilon = \dfrac{c}{a}$. Et comme $a>c$, on a bien $\varepsilon<1$.\\
Les foyers sont $F_1(-c,0)$ et $F_2(c,0)$.\\
Les directrices associées sont $d_{F_1} \equiv x = \dfrac{-a^2}{c}$ et $d_{F_2} \equiv x = \dfrac{a^2}{c}$.\\

L'ellipse possède 2 équations monofocales équivalentes :
\begin{equation}
