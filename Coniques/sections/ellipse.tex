...
\marginpar{\raisebox{-.2ex}{\includegraphics[height=4ex]{./images/icon/roue.PNG}}\footnotemark[1]}
...
\marginpar{\raisebox{-.2ex}{\includegraphics[height=4ex]{./images/icon/roue.PNG}}\footnotemark[2]}
...
\rem{
Que se passe-t-il lorsqu'on fait varier l'excentricité $\varepsilon $ ?\marginpar{\raisebox{-.2ex}{\includegraphics[height=4ex]{./images/icon/roue.PNG}}\footnotemark[1]}
...
\vspace{4cm}
\rem{
Que se passe-t-il si $a=b$ dans l'équation cartésienne? Et si $a<b$ ?\marginpar{\raisebox{-.2ex}{\includegraphics[height=4ex]{./images/icon/roue.PNG}}\footnotemark[2]} 
%Lorsque $a=b$, on trouve l'équation du cercle. En effet, $c=0$, les 2 foyers sont confondus au centre. 
}
