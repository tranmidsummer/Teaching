...
\begin{tabular}{|>{\centering\arraybackslash}m{3cm}|>{\centering\arraybackslash}m{7cm}|>{\centering\arraybackslash}m{7cm}|}
    \hline
     ...
     \hline
     Schéma & \includegraphics[scale=0.7]{sections/tikz_standalone/ell_10.pdf} & \includegraphics[scale=0.7]{sections/tikz_standalone/ell_11.pdf}\\
     \hline
\end{tabular}
\end{center}
\clearpage
...
\begin{tabular}{|>{\centering\arraybackslash}m{3cm}|>{\centering\arraybackslash}m{7cm}|>{\centering\arraybackslash}m{7cm}|}
    \hline
     ...
     Excentricité &  &  \\
     \hline
     Schéma & \includegraphics[scale=0.7]{sections/tikz_standalone/ell_12.pdf} & \includegraphics[scale=0.7]{sections/tikz_standalone/ell_13.pdf}\\
     \hline
\end{tabular}
\end{center}
\addtocounter{page}{-2}
