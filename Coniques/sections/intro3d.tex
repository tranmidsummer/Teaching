...
\vfill
Orbite elliptique de Sedna \raisebox{-.7ex}{\includegraphics[height=4ex]{./images/icon/video.PNG}} \footnote[1]{NASA, \url{https://science.nasa.gov/photojournal/sedna-orbit-animation/}}
\begin{figure}[!ht]
...
\vspace{1cm}
    ...
    \end{subfigure}
\end{figure}
\footnotetext[1]{ESA, \url{https://www.esa.int/Space_in_Member_States/Belgium_-_Francais/La_grande_antenne_de_Redu_destinee_aux_satellites_Galileo}}
\footnotetext[2]{Institute of materials science Uzbekistan academy of science, \url{https://imssolar.uz/en/}}
\footnotetext[3]{PROMES CNRS, \url{https://www.promes.cnrs.fr/infrastructures-solaires/fours-solaires-et-systemes-solaires-a-concentration/}}
\footnotetext[4]{Atelier du zephyr, \url{https://atelierduzephyr.org/auto-construction/cuisiner/cuiseur-et-four-solaires/}}
