...
\begin{figure}[!htb]
    ...
    \caption[Section de cône]{Les coniques propres comme sections de cône \raisebox{-.2ex}{\includegraphics[height=4ex]{./images/icon/roue.PNG}} \footnotemark }
    \vspace{0.5cm}
...
\end{figure}
\footnotetext{Jacques Marot, \url{https://www.geogebra.org/m/yvmuuvx9#material/ccfsaRq3}}
...
\vfill
Orbite elliptique de Sedna \raisebox{-.7ex}{\includegraphics[height=4ex]{./images/icon/video.PNG}} \footnote{NASA, \url{https://science.nasa.gov/photojournal/sedna-orbit-animation/}}
\begin{figure}[!ht]
    \includegraphics[width = 5cm]{./images/applications/sedna_nb.PNG}
\end{figure}

Orbite hyperbolique de la comète C/2012 S1 (ISON) \raisebox{-.7ex}{\includegraphics[height=4ex]{./images/icon/video.PNG}} \footnote{NASA, \url{www.youtube.com/watch?v=40wICUY5VmU}}
\begin{figure}[!ht]
...
\begin{figure}[!ht]
    ...
    \caption[Antennes]{Antennes pour capter les signaux des satellites Galileo\footnotemark[4].}
    \end{subfigure}
\hfill
    \begin{subfigure}{0.4\textwidth}
    \includegraphics[width=\textwidth]{./images/applications/four_parkent_nb.jpg}
    \caption[Parkent]{Four solaire à Parkent, Ouzbékistan \footnotemark[5].}
    \end{subfigure}
\vspace{1cm}
...
\hfill
    ...
    \caption[Odeillo]{Four solaire à Odeillo, France\footnotemark[6].}
    \end{subfigure}
\vspace{1cm}
    \begin{subfigure}{0.4\textwidth}
        \includegraphics[width=\textwidth]{./images/applications/four_sol_nb.jpg}
    \caption[four]{Four solaire pour cuisiner \footnotemark[7].}
    \end{subfigure}
\end{figure}
...
\begin{figure}[!ht]
    ...
    \caption[Lampe Zeiss]{Lampe aux halogénures métalliques pour microscope à fluorescence \footnotemark[7].}
    \end{subfigure}
\hfill
    \begin{subfigure}{0.4\textwidth}
    \includegraphics[width=\textwidth]{./images/applications/zeis_1_nb.PNG}
    \caption[Réflecteur elliptique 2]{Réflecteur elliptique dans une lampe pour microscope à fluorescence, source alignée sur un foyer \footnotemark[8]}
    \end{subfigure}
\vspace{1cm}
    \begin{subfigure}{0.4\textwidth}
        \includegraphics[width=\textwidth]{./images/applications/kbmirror_nb.PNG}
    \caption[KF]{Miroir Kirkpatrick-Baez (KB) \footnotemark[10].}
    \end{subfigure}
\hfill
    \begin{subfigure}{0.4\textwidth}
        \includegraphics[width=\textwidth]{./images/applications/cassegrain_nb.png}
    \caption[Cassegrain]{Télescope cassegrain avec un miroir hyperbolique et un miroir parabolique \footnotemark[11].}
    \end{subfigure}
\vspace{1cm}
    \begin{subfigure}{0.4\textwidth}
        \includegraphics[width=\textwidth]{./images/applications/hubble_design_nb.PNG}
    \caption[Hubble]{Télescope Hubble avec une variante du télescope Cassegrain à 2 miroirs hyperboliques (Ritchey–Chrétien)\footnotemark[12].}
    \end{subfigure}
\end{figure}

\footnotetext[8]{Zeiss, \url{https://zeiss-campus.magnet.fsu.edu/print/lightsources/metalhalide-print.html}}
\footnotetext[9]{Zeiss, \url{https://zeiss-campus.magnet.fsu.edu/tutorials/ellipticalreflectors/indexflash.html}}
\footnotetext[10]{National Accelerator Laboratory, SLAC, Stanford, \url{https://www6.slac.stanford.edu/news/2011-10-11-k-b-mirrors-harness-x-rays-science}}
\footnotetext[11]{Wikipedia, \url{https://en.wikipedia.org/wiki/Cassegrain_reflector#/media/File:Cassegrain_Telescope.svg}}
\footnotetext[12]{NASA, \url{https://ntrs.nasa.gov/citations/19860055868}}
\newpage
...
\begin{figure}[!htb]
    ...
    \caption[Tihange]{Tours de refroidissement de la centrale électrique de Tihange en forme d'hyperboloïde\footnotemark[13].}
    \end{subfigure}
    \hfill
        \begin{subfigure}{0.5\textwidth}
        \includegraphics[width=\textwidth]{./images/applications/varsovie_train_nb.jpg}
    \caption[Varsovie]{Gare en forme de paraboloïde hyperbolique à Varsovie \footnotemark[14].}
    \end{subfigure}
\end{figure}

\footnotetext[13]{Engie, \url{https://nuclear.engie-electrabel.be/fr/les-centrales-nucleaires-en-belgique}}
\footnotetext[14]{Wikipedia, \url{https://en.wikipedia.org/wiki/Warszawa_Ochota_railway_station}}
