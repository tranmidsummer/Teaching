...
\newpage
\lemma{ \label{lemme_c_s} Soit une sphère $\mathcal{S}$ et un point $V$ fixé à l'extérieur de $\mathcal{S}$. Tous les segments reliant $V$ à un point $M$ de la sphère, de sorte que la droite $VM$ soit tangente à la sphère $\mathcal{S}$, ont la même longueur.}
