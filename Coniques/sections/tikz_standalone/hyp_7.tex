...
% Ellipe
\coordinate (S2) at (1.732,0);
\coordinate (S1) at (-1.732,0);
\coordinate (F1) at (-2.5,0);
\coordinate (F2) at (2.5,0);
\coordinate (M) at ({3*cos(45)},{sin(45)});
...
\draw (S2)node{$|$};
\draw (S2)node[below, yshift=-4pt]{$a$};
\draw (S1)node{$|$};
\draw (S1)node[below, yshift=-4pt]{$-a$};
\draw (0,0.7)node{\_};
\draw (0,0.7)node[left]{1};
\draw (0.7,0)node{$|$};
\draw (0.7,0)node[below, yshift=-4pt]{1};
\draw (2.5,0)node{$|$};
\draw (2.5,0)node[below, yshift=-4pt]{$c$};
\draw (-2.5,0)node{$|$};
\draw (-2.5,0)node[below, yshift=-4pt]{$-c$};
