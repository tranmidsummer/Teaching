...
\draw[line width = 3pt] (4*\cellwidth,0) -- (4*\cellwidth,\pageheight);
%ligne
\draw[line width = 5pt] (0,\rowsmin*\cellheight) -- (\pagewidth,\rowsmin*\cellheight);
%ligne
\draw[line width = 3pt] (0,4*\cellheight) -- (\pagewidth,4*\cellheight);
...
\node[rotate=90] at ($ (0,\rowsmin*\cellheight) + (4.5*\cellwidth,0.5*\cellheight) $)  {Coniques dégénérées};
...
\fill[green,opacity=0.3] (1.1*\cellwidth,6.1*\cellheight) rectangle (4.9*\cellwidth,6.9*\cellheight);
\node[rotate=90] at (3*\cellwidth,6.5*\cellheight) {Page \pageref{section:coneplan}};




\fill[blue,opacity=0.3] (1.1*\cellwidth,2.1*\cellheight) rectangle (4.9*\cellwidth,2.9*\cellheight);
\node[rotate=90] at (3*\cellwidth,2.5*\cellheight) {Page \pageref{section:generale}};

\fill[red,opacity=0.3] (1.1*\cellwidth,1.1*\cellheight) rectangle (3.9*\cellwidth,1.9*\cellheight);
\node[rotate=90] at (2.5*\cellwidth,1.5*\cellheight) {Page \pageref{section:tangentes}};
\fill[magenta,opacity=0.3] (1.1*\cellwidth,0.1*\cellheight) rectangle (3.9*\cellwidth,0.9*\cellheight);
\node[rotate=90] at (2.5*\cellwidth,0.5*\cellheight) {Page \pageref{section:optique}};


\node[rotate=90] at (1.5*\cellwidth,5.5*\cellheight) {Page \pageref{section:ellbifo}};
\node[rotate=90] at (3.5*\cellwidth,5.5*\cellheight) {Page \pageref{section:hypbifo}};
\node[rotate=90] at (1.5*\cellwidth,4.5*\cellheight) {Page \pageref{section:ellmonofo}};
\node[rotate=90] at (2.5*\cellwidth,4.5*\cellheight) {Page \pageref{section:paramonofo}};
\node[rotate=90] at (3.5*\cellwidth,4.5*\cellheight) {Page \pageref{section:hypmonofo}};
\node[rotate=90] at (1.5*\cellwidth,3.5*\cellheight) {Page \pageref{section:ellgraphe}};
\node[rotate=90] at (2.5*\cellwidth,3.5*\cellheight) {Page \pageref{section:paragrap}};
\node[rotate=90] at (3.5*\cellwidth,3.5*\cellheight) {Page \pageref{section:hypgraphe}};
\end{scope}
