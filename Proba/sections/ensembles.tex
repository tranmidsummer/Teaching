...
\newpage
    ...
    \prop{Si $A\subset\Omega$, et $A^c = \Omega \setminus A $ le complémentaire de $A$ dans $\Omega$. \\Par définition, $A$ et $A^c$ sont disjoints et $A\cup A^c= \Omega$ donc $$\mu (A) + \mu(A^c)= \mu(\Omega)$$}
    \end{tcolorbox}
      \ex{
